  ...
  if (req.method === "POST") {
    try {
      ...
      const couponTreeAddress = new PublicKey(
        process.env.NEXT_PUBLIC_COUPON_TREE_ADDRESS!,
      );
      ...
      const couponCollectionMint = new PublicKey(
        process.env.NEXT_PUBLIC_COUPON_COLLECTION_MINT!,
      );
      const couponCollectionMetadataAccount = new PublicKey(
        process.env.NEXT_PUBLIC_COUPON_COLLECTION_METADATA_ACCOUNT!,
      );
      const couponCollectionMasterEditionAccount = new PublicKey(
        process.env.NEXT_PUBLIC_COUPON_COLLECTION_MASTER_EDITION_ACCOUNT!,
      );
