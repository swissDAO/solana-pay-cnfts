...
export default async function handler(
  ...
  if (req.method === 'POST') {
    try {
      ...
      const receiptTreeAddress = new PublicKey(
        process.env.NEXT_PUBLIC_RECEIPT_TREE_ADDRESS!,
      );
      const receiptTreeAuthority = new PublicKey(
        process.env.NEXT_PUBLIC_RECEIPT_TREE_AUTHORITY!,
      );
      const receiptCollectionMint = new PublicKey(
        process.env.NEXT_PUBLIC_RECEIPT_COLLECTION_MINT!,
      );
      const receiptCollectionMetadataAccount = new PublicKey(
        process.env.NEXT_PUBLIC_RECEIPT_COLLECTION_METADATA_ACCOUNT!,
      );
      const receiptCollectionMasterEditionAccount = new PublicKey(
        process.env.NEXT_PUBLIC_RECEIPT_COLLECTION_MASTER_EDITION_ACCOUNT!,
      );
      ...
      async function createCollectionNftURI() {
        ...
        const receiptImgUri =
          'https://arweave.net/Aw4FYdlYsv_nLCZILfaWvigEi5QcCSixW3BSuQxXAOY';
        const couponImgUri =
          'https://arweave.net/ZtxAhRnumxH3i-z-gimT3OR2qgV4LjOSjYCX4S4KpBE';
      ...
      console.log(
        `Minting a single receipt compressed NFT to ${buyerPublicKey}...`,
      );
