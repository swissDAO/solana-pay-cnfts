  ...
  */
    ...
    const uploadNFTMetadataURI = async () => {
      ...
      const NFT_CONFIG = {
        ...
        attributes: [
          {
            trait_type: "Original Buyer",
            value: testWallet.publicKey.toBase58(),
          }, //Wallet Address of the Original Buyer
    ...
    console.log(`===============================`);
    console.log(`NEXT_PUBLIC_COUPON_METADATA_URI=${nft_metadata_uri}`);
    console.log(`NEXT_PUBLIC_COUPON_TREE_ADDRESS=${tree.treeAddress.toBase58()}`);
    console.log(`NEXT_PUBLIC_COUPON_TREE_AUTHORITY=${tree.treeAuthority.toBase58()}`);
    console.log(`NEXT_PUBLIC_COUPON_COLLECTION_MINT=${collection.mint.toBase58()}`);
    console.log(`NEXT_PUBLIC_COUPON_COLLECTION_METADATA_ACCOUNT=${collection.metadataAccount.toBase58()}`);
    console.log(`NEXT_PUBLIC_COUPON_COLLECTION_MASTER_EDITION_ACCOUNT=${collection.masterEditionAccount.toBase58()}`);
    console.log(`===============================`);
  } catch (error) {
    console.error(error);
  }
